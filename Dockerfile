...
ENV PORT=3001 \
    ...
    JWT_EXPIRES_IN=120h \
    MINIO_ENDPOINT=uroom-api-storage.gabogrobier.dev \
    MINIO_PORT=443 \
    MINIO_USE_SSL=true \
    MINIO_ACCESS_KEY=minioadmin \
    MINIO_SECRET_KEY=minioadmin123 \
    MINIO_PUBLIC_URL=https://uroom-api-storage.gabogrobier.dev \
    URL_S3_CARNETS=https://uroom-api-storage.gabogrobier.dev/carnets/ \
    PYTHON_SERVICE_URL=http://100.24.130.132:8002 \
    URL_S3_CERTIFICADOS=https://uroom-api-storage.gabogrobier.dev/certificados/
